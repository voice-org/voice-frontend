...
export default function HomePage() {
  ...
  const [view, setView] = useState<
    "landing" | "join" | "signin" | "forgot-password" | "otp-verification"
  >("landing");
  ...
  const leftScrollerPosts = [
    ...leftColumnPosts,
    ...leftColumnPosts,
    ...leftColumnPosts,
  ];
  const rightScrollerPosts = [
    ...rightColumnPosts,
    ...rightColumnPosts,
    ...rightColumnPosts,
  ];
      ...
      <div className="w-full max-w-[1250px] h-full flex flex-col lg:flex-row bg-transparent overflow-hidden mx-auto">
        ...
        <div className="w-full lg:w-[40%] xl:w-[35%] h-full bg-transparent relative z-10 overflow-hidden flex flex-col">
          <div className="flex-grow relative w-full h-full">
            {/* Landing View */}
            <div
              className={`absolute inset-0 p-8 md:p-12 flex flex-col justify-between transition-all duration-500 ease-in-out transform ${view === "landing" ? "translate-x-0 opacity-100 visible" : "-translate-x-full opacity-0 invisible"}`}
            >
              <div className="flex-grow flex flex-col justify-center max-w-md mx-auto w-full">
                ...
                <div className="space-y-4 w-full">
                  <button
                    ...
                    className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-3.5 px-6 rounded-full transition-all shadow-md text-lg active:scale-[0.98]"
                  >
                    Join VOICE Today
                  </button>
                  <button
                    onClick={() => setView("signin")}
                    className="w-full bg-white/40 backdrop-blur-sm hover:bg-white/60 dark:bg-black/20 dark:hover:bg-black/30 text-black dark:text-white font-semibold py-3.5 px-6 border border-white/20 dark:border-white/10 rounded-full transition-all text-lg shadow-sm active:scale-[0.98]"
                  >
                    Sign In
                  </button>
                </div>
            ...
            {/* Join Form View */}
            <div
              className={`absolute inset-0 p-8 md:p-12 flex flex-col justify-center transition-all duration-500 ease-in-out transform ${view === "join" ? "translate-x-0 opacity-100 visible" : "translate-x-full opacity-0 invisible"}`}
            >
              <div className="max-w-md mx-auto w-full">
                <button
                  onClick={() => setView("landing")}
                  className="flex items-center gap-2 text-primary hover:text-primary/80 font-semibold mb-6 group transition-all"
                >
                  <ChevronLeft className="w-5 h-5 group-hover:-translate-x-1 transition-transform" />
                  Back
                </button>
                <div className="mb-6">
                  <h2 className="text-3xl font-black text-black dark:text-white mb-1 tracking-tight">
                    Join VOICE
                  </h2>
                ...
                <form className="space-y-4" onSubmit={handleMockAuth}>
                  ...
                  <div className="flex items-start space-x-2 pt-2">
                    ...
                    <Label
                      htmlFor="terms"
                      className="text-xs text-subtext-light dark:text-subtext-dark leading-snug cursor-pointer font-medium"
                    >
                      I agree to the{" "}
                      <a
                        href="#"
            ...
            {/* Sign In View */}
            <div
              className={`absolute inset-0 p-8 md:p-12 flex flex-col justify-center transition-all duration-500 ease-in-out transform ${view === "signin" ? "translate-x-0 opacity-100 visible" : "translate-x-full opacity-0 invisible"}`}
            >
              <div className="max-w-md mx-auto w-full">
                <button
                  onClick={() => setView("landing")}
                  className="flex items-center gap-2 text-primary hover:text-primary/80 font-semibold mb-8 group transition-all"
                >
                  <ChevronLeft className="w-5 h-5 group-hover:-translate-x-1 transition-transform" />
                  Back
                </button>
                <div className="mb-8">
                  ...
                  <p className="text-subtext-light dark:text-subtext-dark">
                    Sign in to see what the world is saying.
                  </p>
                </div>
                <form className="space-y-4" onSubmit={handleMockAuth}>
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      required
                      placeholder="john@example.com"
                      className="w-full px-4 py-3 rounded-none bg-white/50 backdrop-blur-sm border border-white/20 dark:border-white/10 dark:bg-black/20 focus:ring-primary focus:border-primary transition-all dark:text-white outline-none"
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <button
                    type="submit"
                    className="w-full h-12 rounded-full text-lg font-bold shadow-lg bg-primary hover:bg-primary/90 mt-6 transition-all active:scale-[0.98] text-white"
                  >
                    Sign In
                  </button>
                </form>
            ...
            <div
              className={`absolute inset-0 p-8 md:p-12 flex flex-col justify-center transition-all duration-500 ease-in-out transform ${view === "forgot-password" ? "translate-x-0 opacity-100 visible" : "translate-x-full opacity-0 invisible"}`}
            >
              <div className="max-w-md mx-auto w-full">
                <button
                  onClick={() => setView("signin")}
            ...
            <div
              className={`absolute inset-0 p-8 md:p-12 flex flex-col justify-center transition-all duration-500 ease-in-out transform ${view === "otp-verification" ? "translate-x-0 opacity-100 visible" : "translate-x-full opacity-0 invisible"}`}
            >
              <div className="max-w-md mx-auto w-full">
                <button
                  onClick={() => setView("forgot-password")}
                ...
                <form className="space-y-6" onSubmit={handleOtpSubmit}>
                  ...
                  <button
                    type="submit"
                    className="w-full h-12 rounded-full text-lg font-bold shadow-lg bg-primary hover:bg-primary/90 mt-4 transition-all active:scale-[0.98] text-white"
                  >
                    Verify
                  </button>
