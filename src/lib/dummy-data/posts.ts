...
const basePosts: Post[] = [
  ...
  },
  {
    ...
    user: users.artist,
    content:
      "Just finished this new piece! Inspired by the cyberpunk vibes of Night City. What do you think? 🎨✨",
  ...
  },
  {
    ...
    user: users.chef,
    content:
      "Tonight's special: Handmade Fettuccine Carbonara. The secret is in the pecorino. 🍝😋 #ItalianFood #ChefLife",
  ...
  },
  {
    ...
    user: users.creator,
    content:
      "Building VOICE has been an incredible journey. Thanks to everyone for the feedback! More features coming soon. 🛠️✨",
    timestamp: "1h",
    isPinned: true,
...
export const dummyPosts: Post[] = [
  ...
  ...Array.from({ length: 120 }).map((_, i) => {
    ...
    return {
      ...
      image:
        i % 5 === 0
          ? `https://picsum.photos/seed/post_${id}/800/500`
          : undefined,
      stats: {
        comments: (i * 13) % 500,
        reposts: (i * 27) % 1000,
